...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  {name:'Quản lý sản phẩm',url:'',icon:'signal',childs:[{name:'Quản lý đơn hàng',url:'/product/order'},{name:'Quản lý loại sản phẩm',url:'/product/type'},{name:'Quản lý sản phẩm',url:'/product/product'}]}];
  constructor() { }
  ngOnInit(): void {
  }
  ngAfterViewInit() {
