...
namespace API
{
    public class Startup
    {
        ...
        { 
            ...
            services.AddTransient<IItemGroupBusiness, ProductGroupBusiness>();
            services.AddTransient<IProductRepository, ProductRepository>();
            services.AddTransient<IItemBusiness, ProductBusiness>();
            services.AddTransient<INguoiDungRepository, NguoiDungRepository>();
            services.AddTransient<ICustomerBusiness, NguoiDungBusiness>();
